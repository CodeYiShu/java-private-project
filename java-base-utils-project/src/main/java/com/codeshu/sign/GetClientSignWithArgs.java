 ...
 */
public class GetClientSignWithArgs {

	public static void main(String[] args) {
		new GetClientSignWithArgs().auth();
	}
	...
	public void  auth() {
		//指定密钥
		String token ="{'memberapi':'caFtJdgUh3It3aeA4TspZ1ay2KF0RsIM'}";
		//将配置文件中的密钥，转为JSON对象
		JSONObject tokenJson = JSONUtil.parseObj(token);
		//模拟请求参数
		String t = "{{myTimeStamp}}";  //时间戳
		String appKey = "memberapi";  //appkey
		String data = "{\"tab\":\"uc\",\"keyword\":\"猪妈\",\"page\":{\"num\":7,\"size\":100}}";
